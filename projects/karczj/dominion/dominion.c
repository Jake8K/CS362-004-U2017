...
//1 make the functions for the 5 cards
//2 make sure the functions are called for these instead of the others
//3 break these cards
...
// embargo
// 5 ************************************************************************ 5
int embargo_func(struct gameState *state, int choice1, int handPos) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case smithy:
        return smithy_func(state, handPos);

    case village:
        return village_func(state, handPos);
    ...
    case great_hall:
            return great_hall_func(state, handPos);
    ...
    case embargo:
        return embargo_func(state, choice1, handPos);
